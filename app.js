...
app.get('/tv/:sessao', function(req, res){
...
app.put('/sessao/:id', function(req, res){

	var idSes = req.params.id;
	console.log("Alterando sessao com id: " +  idSes);
	console.log("Body: " + JSON.stringify(req.body));

	Sessao.update({_id: idSes}, { $set: { categorias: req.body.categorias }}, function(err, num){
...
app.get('/produtos/length/:categoria', function(req, res){

	var idCategoria = req.params.categoria;
	// res.status(200).send([]);
	// res.status(200).json({messagen: "Produtos com a categoria: " + idCategoria});	

	Produtos.find({categoria: idCategoria}).exec(function(err, produtos){
